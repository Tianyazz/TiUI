...
function getImportsExpressionExp(path, hash, loc, context) {
    if (path) {
        ...
        if (existingIndex > -1) {
            ...
            exp = (0, compiler_core_1.createSimpleExpression)(name, false, loc, 3 /* ConstantTypes.CAN_STRINGIFY */);
        ...
        const finalExp = (0, compiler_core_1.createSimpleExpression)(hashExp, false, loc, 3 /* ConstantTypes.CAN_STRINGIFY */);
        ...
        if (existingHoistIndex > -1) {
            return (0, compiler_core_1.createSimpleExpression)(`_hoisted_${existingHoistIndex + 1}`, false, loc, 3 /* ConstantTypes.CAN_STRINGIFY */);
        }
        return context.hoist(finalExp);
    }
    else {
        return (0, compiler_core_1.createSimpleExpression)(`''`, false, loc, 3 /* ConstantTypes.CAN_STRINGIFY */);
    }
}
