...
function compileScript(sfc, options) {
    ...
    function checkInvalidScopeReference(node, method) {
        ...
        (0, compiler_dom_1.walkIdentifiers)(node, (id) => {
            ...
            if (binding && binding !== "literal-const" /* BindingTypes.LITERAL_CONST */) {
...
__ins.emit(event, ...do_not_transform_spread)
    ...
    if (refBindings) {
        for (const key of refBindings) {
            ctx.bindingMetadata[key] = "setup-ref" /* BindingTypes.SETUP_REF */;
        }
    }
...
function walkDeclaration(from, node, bindings, userImportAliases, hoistStatic) {
    ...
    if (node.type === 'VariableDeclaration') {
        ...
        for (const { id, init: _init } of node.declarations) {
            ...
            if (id.type === 'Identifier') {
                ...
                if ((hoistStatic || from === 'script') &&
                    ...
                    bindingType = "literal-const" /* BindingTypes.LITERAL_CONST */;
                }
        ...
        bindings[node.id.name] = isAllLiteral
            ? "literal-const" /* BindingTypes.LITERAL_CONST */
            : "setup-const" /* BindingTypes.SETUP_CONST */;
    }
