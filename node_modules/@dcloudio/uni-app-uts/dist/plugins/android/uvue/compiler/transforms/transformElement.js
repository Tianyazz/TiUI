        ...
        if (node.children.length > 0) {
            ...
            if (shouldBuildAsSlots) {
                ...
                if (hasDynamicTextChild &&
                    (0, compiler_core_1.getConstantType)(child, context) === 0 /* ConstantTypes.NOT_CONSTANT */) {
...
function resolveComponentType(node, context, ssr = false) {
    ...
    const isDir = !isExplicitDynamic && (0, compiler_core_1.findDir)(node, 'is');
    if (isDir && isDir.exp) {
        if (utils_1.__DEV__) {
            context.onWarn((0, errors_1.createCompilerError)(52 /* ErrorCodes.DEPRECATION_V_IS */, isDir.loc));
        }
        return (0, compiler_core_1.createCallExpression)(context.helper(compiler_core_1.RESOLVE_DYNAMIC_COMPONENT), [
            isDir.exp,
        ]);
...
function resolveSetupReference(name, context) {
    ...
    const fromConst = checkType("setup-const" /* BindingTypes.SETUP_CONST */) ||
        ...
        checkType("literal-const" /* BindingTypes.LITERAL_CONST */);
    if (fromConst) {
    ...
    const fromProps = checkType("props" /* BindingTypes.PROPS */);
    if (fromProps) {
...
function buildProps(node, context, props = node.props, isComponent, isDynamicComponent, ssr = false) {
    ...
    const analyzePatchFlag = ({ key, value }) => {
        if ((0, compiler_core_1.isStaticExp)(key)) {
            ...
            if (isEventHandler && value.type === 14 /* NodeTypes.JS_CALL_EXPRESSION */) {
    ...
    for (let i = 0; i < props.length; i++) {
        ...
        if (prop.type === 6 /* NodeTypes.ATTRIBUTE */) {
            ...
            properties.push((0, compiler_core_1.createObjectProperty)((0, compiler_core_1.createSimpleExpression)(name, true, (0, compiler_core_1.getInnerRange)(loc, 0, name.length)), (0, compiler_core_1.createSimpleExpression)(value ? value.content : '', isStatic, value ? value.loc : loc)));
        }
        else {
            // directives
                        ...
                        if (utils_1.__COMPAT__) {
                            ...
                            if (utils_1.__DEV__) {
                                ...
                                if (hasOverridableKeys) {
                                    (0, compiler_core_1.checkCompatEnabled)("COMPILER_V_BIND_OBJECT_ORDER" /* CompilerDeprecationTypes.COMPILER_V_BIND_OBJECT_ORDER */, context, loc);
                                }
                            }
                        }
                        mergeArgs.push(exp);
            ...
            if (isVBind && modifiers.includes('prop')) {
                patchFlag |= 32 /* PatchFlags.NEED_HYDRATION */;
            }
    ...
    if (!shouldUseBlock &&
        (patchFlag === 0 || patchFlag === 32 /* PatchFlags.NEED_HYDRATION */) &&
