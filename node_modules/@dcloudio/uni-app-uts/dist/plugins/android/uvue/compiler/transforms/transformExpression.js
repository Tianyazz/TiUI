        ...
        if (inline) {
            ...
            if (isConst(type) ||
                ...
                if (isAssignmentLVal) {
                    ...
                    return `${context.helperString(compiler_core_1.IS_REF)}(${raw}) ? ${raw}.value ${operator} ${rExpString} : ${raw}`;
                }
                else if (isUpdateArg) {
                    ...
                    // let binding.
                    // x++ --> isRef(a) ? a.value++ : a++
                    return `${context.helperString(compiler_core_1.IS_REF)}(${raw}) ? ${prefix}${raw}.value${postfix} : ${prefix}${raw}${postfix}`;
                }
...
function isConst(type) {
    return (type === "setup-const" /* BindingTypes.SETUP_CONST */ || type === "literal-const" /* BindingTypes.LITERAL_CONST */);
}
